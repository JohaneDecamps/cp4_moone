...
<div className="input-add-article"> 
        <label htmlFor="description" className="input-description-add"> Description </label>
        <input
          type="text"
          name="description"
...
<div className="input-add-article"> 
        ...
        >
          <option value="" className="input-category-article"> Selectionnez une categorie </option>
          {category?.map((c) => (
            <option className="input-category-article" key={c.id} value={c.id}>
              {c.name}
            </option>
          ))}
        </select>
